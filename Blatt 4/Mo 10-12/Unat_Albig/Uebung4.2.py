...
x1 = [2+math.sin(0.2*t +8)*math.sqrt(t+10) for t in u]
x2 = [-1+math.cos(0.2*t +8)*math.sqrt(t+10) for t in u]

x4 = [-1+math.cos(0.2*t-8)*math.sqrt(t+10) for t in u]
x3 = [2+math.sin(0.2*t -8)*math.sqrt(t+10) for t in u]
